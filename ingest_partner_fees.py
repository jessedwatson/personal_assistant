...
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = '/Users/jessew/personal_assistant/creds.json'
...
wb = openpyxl.load_workbook('/Users/jessew/Downloads/Partner Fee Structure.xlsx', data_only=True)
ws = wb['data']
